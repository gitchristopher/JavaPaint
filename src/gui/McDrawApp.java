...
import static files.VecFile.OpenFileDlg;
import static files.VecFile.SaveFileDlg;

/**
 * @author Marron Hawas & Christopher Linnan
 * @version 1.0
 */
public class McDrawApp extends JFrame
{
    ...
    public McDrawApp(){
        ...
        btnSelectFillColour = MakeFunctionalButton("","Select a fill colour, select cancel to remove fill","./Images/FILL.png",4);
        ...
        JLabel zoomRestLabel = new JLabel("Reset");
