...
public class VecFile
{
    ...
    private static void OpenFile(File selectedFile)
    {
        ...
        }catch (IOException e)
        {
            ...
            JOptionPane.showMessageDialog(null, "VEC file failed to load", "Load failure", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }catch (Exception e) {
    ...
    private static void SaveFile(ArrayList<McShape> McShapeList, File aNewFile)
    {
        ...
        {
            System.out.println("An I/O Error Occurred");
            JOptionPane.showMessageDialog(null, "VEC file failed to save", "Save failure", JOptionPane.ERROR_MESSAGE);
    ...
    private static void LoadData(BufferedReader br) throws IOException
    {
        ...
        {
            System.out.println("An I/O Error Occurred");
            //JColorChooser.showDialog(null,  "Select an edge colour", Color.BLACK);
            JOptionPane.showMessageDialog(null, "VEC file failed to load", "Load failure", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
